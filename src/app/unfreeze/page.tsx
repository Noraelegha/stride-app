...
export default function UnfreezePage() {
  ...
  return (
    <div style={{ position: 'relative', flex: 1, minHeight: '100vh', overflow: 'hidden' }}>
      ...
      >
        {/* Shield + sunrays container */}
        <div style={{ position: 'relative', width: 160, height: 160, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>

          {/* Sunrays SVG — 220x220, centred, 28% opacity */}
          <svg
            width="220" height="220"
            style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', opacity: 0.28, zIndex: 0 }}
            viewBox="0 0 220 220"
          >
          ...
          {/* Shield SVG — 130x130, z-index 1, pulsing */}
          <div style={{
            ...
            <svg width="130" height="130" viewBox="0 0 120 130" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
              ...
              {/* Outer white border */}
              <path
                d="M60 4 L20 22 L8 58 C8 90 30 112 60 126 C90 112 112 90 112 58 L100 22 Z"
                fill="white"
                fillOpacity="0.88"
              />
              {/* Inner gradient body */}
              <path
                d="M60 12 L26 28 L16 60 C16 88 35 107 60 120 C85 107 104 88 104 60 L94 28 Z"
                fill="url(#shieldGrad)"
              />

              {/* Water drop */}
              <path
                d="M60 52 C60 52 48 66 48 74 C48 81 53 86 60 86 C67 86 72 81 72 74 C72 66 60 52 60 52Z"
                fill="#0288D1"
                fillOpacity="0.85"
              />
              {/* Droplet shine */}
        ...
        <p style={{
          ...
          lineHeight: 1.55, margin: 0, maxWidth: '260px', textAlign: 'center',
        }}>
            ...
            return (
              <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '5px' }}>
                ...
                <div style={{
                  ...
                  background: active ? '#FF9500' : missed ? '#ffeded' : '#f0f0f0',
                  border: missed ? '1.5px solid #ffb3b3' : 'none',
